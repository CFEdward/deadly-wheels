...
#include "DeadlyWheelsOffroadCar.h"
#include "DeadlyWheelsOffroadWheelFront.h"
#include "DeadlyWheelsOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

ADeadlyWheelsOffroadCar::ADeadlyWheelsOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UDeadlyWheelsOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UDeadlyWheelsOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UDeadlyWheelsOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UDeadlyWheelsOffroadWheelRear::StaticClass();
