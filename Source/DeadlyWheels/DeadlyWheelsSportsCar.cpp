...
ADeadlyWheelsSportsCar::ADeadlyWheelsSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UDeadlyWheelsSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UDeadlyWheelsSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UDeadlyWheelsSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UDeadlyWheelsSportsWheelRear::StaticClass();
